...
namespace APIBlox.AspNetCore.Controllers
{
    ...
    [ApiController]
    public sealed class DynamicPostController<TRequest, TResponse> : ControllerBase,
        ...
        where TResponse : IResource
    {
        ...
        private readonly ILogger<DynamicPostController<TRequest, TResponse>> _log;

        /// <summary>
        ///     Initializes a new instance of the <see cref="DynamicPostController{TRequest, TResponse}" /> class.
        /// </summary>
        ...
        public DynamicPostController(ILoggerFactory loggerFactory, ICommandHandler<TRequest, HandlerResponse> createCommand)
        {
            ...
            _log = loggerFactory.CreateLogger<DynamicPostController<TRequest, TResponse>>();
        }
